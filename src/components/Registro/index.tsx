           ...
           <Body>
            ...
            <BodyMobile>
                <PageContainer>
                    ...
                    <Span style={{display:"flex", justifyContent:"center", marginBottom:"5vh"}}>
                        ¡Registrate Gratis!
                    </Span>
                    <Form>
                        <Input type="email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)}/>
                        <UserInput>
                            <label style={UserLabel}>rappdtech/links/</label>
                            <UserInputField type="username" autoComplete="username" placeholder="usuario" value={username} onChange={(e) => setUsername(e.target.value)} />
                        </UserInput>
                        ...
                        <Button onClick={() => handleEmailSignUp(email, password)}>Crear Cuenta</Button>
                        <Span style={{display:"flex", justifyContent:"center", marginTop:"1rem"}}>
                            Al hacer clic en Crear cuenta, acepta los Términos y Condiciones de RAppID Links y confirma que ha leído nuestro Aviso de privacidad. Podrás recibir ofertas, noticias y actualizaciones nuestras.
                        </Span>
                        ...
                        <Anchor style={{color: '#A84AC9'}} href="https://rappidtech.com/links/login">
